...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("MYSQL_DATABASE", "randojdb"),
        "USER": os.environ.get("MYSQL_USER", "randojdb"),
        "PASSWORD": os.environ.get("MYSQL_PASSWORD", "sapience35986221'miscall"),
        "HOST": os.environ.get("MYSQL_HOST", "mysql.csh.rit.edu"),
        "OPTIONS": {
            "charset": "utf8mb4",
...
# CELERY_BROKER_URL_SECRET = "redis://redis:6379/0"
